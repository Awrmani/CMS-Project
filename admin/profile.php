...
if (isset($_SESSION['username'])) {
    ...
    confirmQuery($userProfile);

    while ($row = mysqli_fetch_array($userProfile)) {
        $userId = $row['user_id'];
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <select class="form-select" name="user_role" id="user_role">
                            <option <?php if ($userRole === "admin") {
                                        print("selected");
                                    } ?> value="admin">Admin</option>
                            <option <?php if ($userRole === "viewer") {
                                        print("selected");
                    ...
                    <div class="form-group">
                        <input class="btn btn-primary" type="submit" name="profile_update" value="Update Profile">
                    </div>
                </form>
